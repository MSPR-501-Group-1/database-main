...
-- social_post
-- ============================================================
INSERT INTO social_post (post_id, user_id, text, created_at) VALUES
  ('POST_001', 'USR_001', 'Première séance de sport de la semaine, motivation au top ! 🏋️‍♂️', '2026-06-20 10:00:00'),
  ('POST_002', 'USR_002', 'Petit-déjeuner sain et équilibré ce matin : flocons d’avoine, bananes et miel. 🍌🥣', '2026-06-20 10:15:00'),
  ('POST_003', 'USR_003', 'Retour en images sur ma randonnée de ce week-end dans les Alpes ! 🏔️🥾', '2026-06-20 10:30:00'),
  ('POST_004', 'USR_004', 'Tutoriel rapide pour maîtriser les pompes avec la bonne posture. 💪', '2026-06-20 10:45:00'),
  ('123e4567-e89b-12d3-a456-426614174000', 'USR_001', 'Post de test pour l''upload de nouvelles vidéos via Postman/API.', '2026-06-20 11:00:00')
...
-- social_post_media
-- ============================================================
INSERT INTO social_post_media (media_id, post_id, media_url, media_type, thumbnail_url, process_status, raw_object_key, created_at) VALUES
  -- POST_002 (Simple image)
  ('MEDIA_001', 'POST_002', 'http://localhost:9000/production-medias/breakfast.jpg', 'image', NULL, 'READY', NULL, '2026-06-20 10:15:00'),
  -- POST_003 (Multi-image)
  ('MEDIA_002', 'POST_003', 'http://localhost:9000/production-medias/mountain1.jpg', 'image', NULL, 'READY', NULL, '2026-06-20 10:30:00'),
  ('MEDIA_003', 'POST_003', 'http://localhost:9000/production-medias/mountain2.jpg', 'image', NULL, 'READY', NULL, '2026-06-20 10:30:00'),
  -- POST_004 (Video)
  ('MEDIA_004', 'POST_004', 'http://localhost:9000/production-medias/pushup_processed.mp4', 'video', 'http://localhost:9000/production-medias/pushup_thumbnail.jpg', 'READY', 'uploads/pushup_raw.mp4', '2026-06-20 10:45:00')
